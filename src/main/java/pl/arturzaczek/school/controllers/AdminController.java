...
public class AdminController {
    ...
    public String addNewRole(@RequestParam (defaultValue = "ROLE_USER")Roles new_role, @RequestParam String user_id, Model model) {
        System.out.println(user_id + " "+ new_role);
        boolean success = roleService.addNewRole(user_id, new_role);
